...
class RedisSessionStorage(SessionManager):
    ...
    def __init__(self, host='localhost', port=6379, db=0, password='1ee5f1d25745de4d5ccc09a69119da6c82636cdb20bed280e595ed16cee6301a'):
        #self.c = redis.StrictRedis(host=host, port=port, db=db, password=password)
